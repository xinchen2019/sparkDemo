...
public class HiveDataSource {
    public static void main(String[] args) {
        ...
        hiveContext.sql(" CREATE DATABASE IF NOT EXISTS apple ");
        hiveContext.sql(" use apple ");
        ...
        hiveContext.sql("LOAD DATA "
                + "LOCAL INPATH 'file:///D://IdeaProjetcts//spark-java//data//student_infos.txt' "
        ...
        hiveContext.sql("LOAD DATA "
                + "LOCAL INPATH 'file:///D://IdeaProjetcts//spark-java//data//student_scores.txt' "
